                                    ...
                                    <DropdownMenu>
                                        ...
                                        <DropdownMenuContent side="left">
                                                    ...
                                                    <DropdownMenuSubContent>
                                                        <DropdownMenuItem onClick={() => onRoleChange(member.id, "GUEST")} >
                                                            <Shield className="h-4 w-4 mr-2" />
                                                                Guest {member.role === "GUEST" && ( <Check className="h-4 w-4 ml-auto" />)}
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem onClick={() => onRoleChange(member.id, "MODERATOR")} >
                                                            <ShieldCheck className="h-4 w-4 mr-2" />
                                                                Moderator {member.role === "MODERATOR" && ( <Check className="h-4 w-4 ml-auto" /> )}
                                                        </DropdownMenuItem>
                                                    </DropdownMenuSubContent>
                                                </DropdownMenuPortal>
                                            </DropdownMenuSub>
                                            ...
                                            <DropdownMenuItem onClick={() => onKick(member.id)} >
                                                <Gavel className="h-4 w-4 mr-2 text-rose-500" /> Kick
                                            </DropdownMenuItem>
                                        </DropdownMenuContent>
                                    </DropdownMenu>
                                </div>
